# Simple script to calculate how many times and in-game bank interest has been accumulated. It accumulates every 48 minutes a character has been logged in. If someone logs out before the 48 minutes is up, the timer restarts and interest is lost. Logging has to be turned on in the game options for the script to work.
